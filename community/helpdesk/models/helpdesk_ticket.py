...
class HelpdeskTicketResolution(models.Model):
    ...
    _description = 'Helpdesk Ticket Resolution'
    _order = 'sequence'
...
class HelpdeskTicket(models.Model):
    ...
    resolution_id = fields.Many2one('helpdesk.ticket.resolution', string="Ticket Resolution")
    ...
    reporter_id = fields.Many2one('res.users', string='Reported From')
    ...
    # 
    is_reattachment = fields.Boolean(string="Reattachment",default=False)
    parent_id = fields.Many2one('helpdesk.ticket', string="Return from origin")
    # SLA relative
