...
com o Correio",
    ...
    def _get_price_params_per_line(self, origem, destino, lines):
        ...
        for line in lines:
            ...
            params['cep_origem'] = re.sub("[^0-9]", "", line.product_id.vendor_id.zip or origem or "")
            comprimento = line.product_id.comprimento
            altura = line.product_id.altura * line.product_uom_qty
            largura = line.product_id.largura * line.product_uom_qty
            weight = line.product_id.weight * line.product_uom_qty
            params.update(
                {
                    "peso": str(weight if weight > 1 else 1),
                    "comprimento": str(
