...
class EtiquetaGeral(models.Model):
    ...
    cliente = fields.Many2one('document_id.document_line_ids', string='Cliente', required=True, size=28, tracking=True)
    produto = fields.Char(string='Produto', required=True,  tracking=True, ondelete='restrict')
